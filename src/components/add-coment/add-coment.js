...
const AddComment = () => {
    ...
    return (
        <form onSubmit={handleFormAddComment} className="add-coment-form" >
                    <label className="add-label" htmlFor="addComment">Add Comment</label>
                    <textarea ref={textareaValue} value={textValue} onChange={handleTextChange} placeholder="Fikringizni qoldiring" className="add-textarea" id="addComment"></textarea>
